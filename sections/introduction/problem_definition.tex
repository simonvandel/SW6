...
\vspace{0.5 cm}
\begin{center}
	\textbf{\textit{How can we develop an application, using aSTEP services, that can analyse position data gathered from events that attracts large crowds, identify relevant information about the behavior of the crowds, and present this information to event staff in an intuitive manner?}}
\end{center}