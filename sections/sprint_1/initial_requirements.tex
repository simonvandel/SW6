...
\lanote{Ret igennem for application vs system.. + our/the application? + Overvej rename af usecases + smartphone/phone/etc.? + skal vi have maintainability of extensibility på som non-funktionelle krav? + evt. fjern prioritering af non-funcktionelle krav}
