...
Firs we consider that the application should be usabl

As the application is developed as a part of the aSTEP multi-project, the application should utilise the aSTEP core to provide the needed location data. Additionally we assume that the aSTEP project will continue on future semesters, future students might continue development of our application.
