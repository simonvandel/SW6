...
Density can be a good indicator for inferring hazardous situations. For instance most stampedes occur in high-density crowds\cite{wirz2012inferring} and there are certain density limits for still-standing crowds, where it becomes highly uncomfortable to be in. 
...
\end{tikzpicture}
\caption{Nonuniform velocity}
\end{subfigure}
\caption{An illustration of the local crowd velocity in different situations}
...
\begin{figure}
    ...
    \caption[Pressure on crowd disaster in Mina/Makkah]{The pressure leading up the the crowd disaster in Mina/Makkah during the Hajj in 1426H on January 12, 2006 \cite{empircalstudy}}
