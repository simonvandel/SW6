...
In \citet{empircalstudy} the video recordings of the crowd disaster in Mina/Makkah during the Hajj on January 12, 2006, was analysed and pressure during the event was calculated. A dangerous crowd behaviour began when the pressure exceeded $0.02 \text{ people} / s^2$, where $s$ denotes seconds. The accident started when the pressure hit its peak of about $0.045 \text{ people} / s^2$. The specific graph can be seen in \cref{mekkahCrowdDistaster206}
