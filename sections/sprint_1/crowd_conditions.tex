...
In \citet{empircalstudy} the video recordings of the crowd disaster in Mina/Makkah during the Hajj on January 12, 2006, was analysed and pressure during the event was calculated. At a pressure of $0.02 \text{ people} / s^2$, where $s$ denotes seconds, the pressure were so high that people were moved around involuntarily. The accident started when the pressure hit its peak of about $0.045-0.04 \text{ people} / s^2$. The specific graph can be seen in \cref{mekkahCrowdDistaster206}. Even though this is an empirical study conducted on a specific accident \citeauthor{empircalstudy} expect the results to be transferable to other mass gatherings.

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Pressure.eps}
    \caption{The pressure leading up the the crowd disaster in Mina/Makkah during the Hajj on January 12, 2006 \cite{empircalstudy}.}
