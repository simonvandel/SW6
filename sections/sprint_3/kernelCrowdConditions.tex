...
This section will expand the function for kernel density estimation, found in the previous section, to functions for calculating the local crowd velocity, turbulence and pressure, the three last factors found for detecting the local crowd condition. The calculations for these crowd factors have been developed by Franke et al in 2012 \cite{wirz2012inferring}. The main difference between the caculations done in their paper and this project is in pressure. 

\subsubsection{Velocity}
The local crowd velocity is essentially calculated as in Franke et al \cite{wirz2012inferring}. 
\begin{equation}
\label{eq:}
...
Pressure is a bit different. The fator were originally intruduced by Helbing et al 2007 \cite{empircalstudy} as 
\begin{equation}
