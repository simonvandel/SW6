...
We added a new user type for festival guests, called guest users. These users are briefly described in \cref{tab:guest_user}. While festival guests share some characteristics with the mobile users described in \cref{tab:mob_user}
Guest users are festival guest that use the system, Festival guests are as potential users of the system, The guest user, described in \cref{tab:guest_user}



The medical and guard users are specialisations of the 
