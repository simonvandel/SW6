...
Considering that there is a physical limit as too how dense people can be packed, the function $PeopleWithinBandwidth(h) = h^2 * \pi * maxDensity$ is considered a constant, giving us the final complexity of $$\mathcal{O}(\text{points} \cdot log(\text{people}))$$.
