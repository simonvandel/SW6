...
This presents a problem, since we want a way to adjust the limit marking which observations should be considered in the estimation, because we do not know how far away observations affect the density.
