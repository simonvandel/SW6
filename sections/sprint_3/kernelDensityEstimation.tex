...
To go from absolute densities to relative densities we simply divide by the area of the absolute density calculation, which is $h^2 \cdot \pi$. The relative density can then be calculated as shown in \cref{eq:relativeDensitiesEpanechnikov}.
