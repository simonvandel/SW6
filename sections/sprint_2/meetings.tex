...
Currently SmukFest uses analysis tools for crowd management, such as the DIM-ICE model, and the extensive literature there exists on the subject \kanote{insert reference}\cite{}. Søren employs a team of experts together with these tools to asses possible problematic situations and plan the schedules for the guards accordingly.
...
\begin{itemize}
    \item More realistic crowds that move in predetermined patterns.\kanote{Er det strengt taget en ændring i systemet, eller blot en ændring i prototypen?}
