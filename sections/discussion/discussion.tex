...
While we have successfully lobbied for a strict control of access to position data stored on the aSTEP servers, the problem persists on an ethical level as long as the data is available. \jenote{What do we think maybe?}
