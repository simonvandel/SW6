...
The max values for each crowd factor follows the values :
...
\sinote{Skriv threshold værdier ind for de 4 faktorer}
...
\sinote{Ved hvilken værdi viser vi ikke længere velocity?}
