...
The test should not be seen as conclusive, as only a single test subject was interviewed. A better test of the system would be in a real environment where the system displays near real-time crowd information.
