...
\sinote{Separer test metoden fra at anders bliver introduceret. Beskriv hvad testen går ud på og hvad vi tester}
...
Anders Nord of Alarm HS, kindly agreed to participate in this user test. The user test was performed over Skype as in other meetings. Anders was presented with the application which was configured to display the following predefined crowd scenarios. 
