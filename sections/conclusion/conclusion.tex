...
\sinote{skal vi have den ekstra spacing?}
\vspace{0.5 cm}
\begin{center}
...
Our solution to the problem was a web application. The application was developed across four sprints, following an agile development process. Three of the four sprints were evaluated with an interview with a potential user of the \lanote{application}system, and the remaining sprint was evaluated internally. This method of development worked great for the project, since it synchronised our work with the other groups in the aTEP multi-project. The deadlines at the end of the sprints and the following planning of a new sprint, also helped us keep the development on the right track.
...
\lanote{Four important crowd factors were identified, namely density, velocity, turbulence, and pressure. }
...
The result of the project can not be concluded as a complete solution to the stated problem, since there are important requirements which have not been met, or have not been adequately confirmed\sinote{Vi kan måske være mere præcise, hvilke løste vi ikke?}. While we firmly believe that the crowd factors are useful for understanding crowd behavior, we were ultimately not able to prove this.
